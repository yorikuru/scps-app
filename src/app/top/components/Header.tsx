      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        <div className="flex sm:hidden items-center gap-1.5 ml-1">
          {currentSchoolData?.logoURL ? (
            ...
            <div className="w-5 h-5 rounded bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-[8px] font-black shadow-2xs">
              {currentSchoolData?.name ? currentSchoolData.name.charAt(0) : "T"}
            </div>
          )}
          <span className="text-[11px] font-black text-gray-800 truncate max-w-[100px]">{currentSchoolData?.name || "テナント"}</span>
        </div>
