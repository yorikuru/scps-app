  ...
  return (
    ...
    <div className="h-[100dvh] w-full bg-[#F9FAFB] font-sans flex flex-col text-gray-900 overflow-hidden relative">
      ...
      <div className="sm:hidden px-2 pt-2 pb-1 shrink-0">
        <button onClick={() => router.back()} className="flex items-center text-[11px] font-bold text-gray-500 bg-white px-2.5 py-1.5 rounded-lg shadow-2xs border border-gray-200 w-fit mt-1 ml-1 transition-colors hover:bg-gray-50">
          <ArrowLeft className="w-3.5 h-3.5 mr-1" /> 戻る
        </button>
      </div>

      <main className="flex-1 overflow-y-auto custom-scrollbar w-full p-2 sm:p-4 lg:p-6 pb-20">
        <div className="max-w-3xl mx-auto w-full flex flex-col gap-3 sm:gap-4">
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 overflow-visible relative">
            ...
            <form onSubmit={handleSave} className="p-3 sm:p-5 lg:p-6 space-y-4 sm:space-y-5">
              ...
              <div className="bg-gray-50/50 p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-gray-200 space-y-3 sm:space-y-4">
                ...
                <div className="relative" ref={userSearchRef}>
                  ...
                  {isSearchUserFocused && searchUserQuery.trim() !== "" && (
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 shadow-xl rounded-lg sm:rounded-xl max-h-48 overflow-y-auto z-50 custom-scrollbar">
              ...
              <div className="pt-3 border-t border-gray-100 flex justify-end pb-4 sm:pb-6">
                <button type="submit" disabled={isSubmitting || !formTitle.trim()} className="w-full sm:w-auto justify-center px-5 sm:px-6 py-2 sm:py-2.5 disabled:opacity-50 text-white text-[11px] sm:text-xs font-bold rounded-lg sm:rounded-xl shadow-md bg-indigo-600 hover:bg-indigo-700 transition-all hover:-translate-y-0.5 flex items-center">
